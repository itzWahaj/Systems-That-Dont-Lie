...
<div className="my-12 max-w-xl mx-auto bg-surface/50 p-4 rounded-lg border border-border">
  <h3 className="text-lg font-serif font-bold text-main mb-4 text-center">Workflow</h3>
...
<div className="my-12 max-w-xl mx-auto bg-surface/50 p-4 rounded-lg border border-white/5">
  <h3 className="text-lg font-serif font-bold text-main mb-4 text-center">Phase Wheel</h3>
...
<div className="my-12 max-w-xl mx-auto bg-surface/50 p-4 rounded-lg border border-white/5">
  <h3 className="text-lg font-serif font-bold text-main mb-4 text-center">System Architecture</h3>
...
<div className="my-12 max-w-xl mx-auto bg-surface/50 p-4 rounded-lg border border-white/5">
  <h3 className="text-lg font-serif font-bold text-main mb-4 text-center">Security Model</h3>
