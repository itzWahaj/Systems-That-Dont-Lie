                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full bg-black/50 border ${errors.date ? 'border-red-500' : 'border-white/10'} rounded-sm py-3 pl-10 pr-4 text-white placeholder:text-gray-600 focus:border-accent focus:outline-none transition-colors [color-scheme:dark]`}
                                            />
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full bg-black/50 border ${errors.time ? 'border-red-500' : 'border-white/10'} rounded-sm py-3 pl-10 pr-4 text-white placeholder:text-gray-600 focus:border-accent focus:outline-none transition-colors [color-scheme:dark]`}
                                            />
                                        </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full bg-black/50 border ${errors[mode === 'appointment' ? 'topic' : 'message'] ? 'border-red-500' : 'border-white/10'} rounded-sm py-3 pl-10 pr-4 text-white placeholder:text-gray-600 focus:border-accent focus:outline-none transition-colors resize-none`}
