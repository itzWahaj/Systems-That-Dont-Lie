            ...
            <div className="max-w-5xl w-full">
                ...
                <AnimeStagger className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <motion.div
                        ...
                        className="anime-item p-8 border border-border bg-surface/50 transition-all duration-300 group relative overflow-hidden"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-5xl md:text-6xl font-bold text-main mb-2 font-mono group-hover:text-accent transition-colors duration-300">Forever</div>
                            <div className="text-accent font-bold uppercase tracking-widest text-sm mb-2">Auditability Window</div>
                            <p className="text-muted text-sm group-hover:text-main transition-colors">Immutable on-chain records.</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-5xl md:text-6xl font-bold text-main mb-2 font-mono group-hover:text-accent transition-colors duration-300">&lt; 2s</div>
                            <div className="text-accent font-bold uppercase tracking-widest text-sm mb-2">Time-to-Tally</div>
                            <p className="text-muted text-sm group-hover:text-main transition-colors">Automated smart contract execution.</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-5xl md:text-6xl font-bold text-main mb-2 font-mono group-hover:text-accent transition-colors duration-300">99.9%</div>
                            <div className="text-accent font-bold uppercase tracking-widest text-sm mb-2">Match Rate</div>
                            <p className="text-muted text-sm group-hover:text-main transition-colors">Biometric identity binding.</p>
                        </div>
                    </motion.div>
                </AnimeStagger>
